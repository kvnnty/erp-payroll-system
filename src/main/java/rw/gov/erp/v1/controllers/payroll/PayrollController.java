...
public class PayrollController {
    ...
    public ResponseEntity<ApiResponse<List<Payslip>>> getPayslipsByMonthAndYear(@RequestParam Integer month,
            @RequestParam Integer year) {
        List<Payslip> payslips = payrollService.getPayslipsByMonthAndYear(month, year);
    ...
    public ResponseEntity<ApiResponse<List<Payslip>>> getMyPayslips(Authentication authentication) {
        ...
        List<Payslip> payslips = payrollService.getEmployeePayslips(userPrincipal.getId());
    ...
    public ResponseEntity<ApiResponse<Payslip>> getMyPayslip(
            @RequestParam Integer month,
            @RequestParam Integer year,
            Authentication authentication) {

        UserPrincipal userPrincipal = (UserPrincipal) authentication.getPrincipal();
        Payslip payslip = payrollService.getEmployeePayslip(userPrincipal.getId(), month, year);
    ...
    public ResponseEntity<ApiResponse<List<Payslip>>> getEmployeePayslips(@PathVariable UUID employeeId) {
        List<Payslip> payslips = payrollService.getEmployeePayslips(employeeId);
